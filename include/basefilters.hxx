 ...
 */
template <typename T> inline auto FilterMax(const T &cut) {
 ...
 * @return a lambda function to be used in RDF Define
 */
template <typename T> inline auto FilterAbsMax(const T &cut) {
    return [cut](const ROOT::RVec<T> &values) {
 ...
 * @return a lambda function to be used in RDF Define
 */
template <typename T> inline auto FilterMin(const T &cut) {
    return [cut](const ROOT::RVec<T> &values) {
        ROOT::RVec<int> mask = values >= cut;
        return mask;
    };
 ...
 * @return a lambda function to be used in RDF Define
 */
template <typename T> inline auto FilterAbsMin(const T &cut) {
    return [cut](const ROOT::RVec<T> &values) {
        ROOT::RVec<int> mask = abs(values) >= cut;
        return mask;
    };
 ...
 * @return a lambda function to be used in RDF Define
 */
template <typename T> inline auto FilterEqual(const T &cut) {
    return [cut](const ROOT::RVec<T> &values) {
        ROOT::RVec<int> mask = values == cut;
        return mask;
    };
 ...
 * @return a lambda function to be used in RDF Define
 */
template <typename T> inline auto FilterAbsEqual(const T &cut) {
    return [cut](const ROOT::RVec<T> &values) {
        ROOT::RVec<int> mask = abs(values) == cut;
        return mask;
    };
 ...
 * @return a lambda function to be used in RDF Define
 */
template <typename T> inline auto FilterBitmask(const int &cut) {
    return [cut](const ROOT::RVec<T> &values) {
        ROOT::RVec<int> mask;
