...
ROOT::RDF::RNode GenerateSingleTriggerFlag(
    ...
    Logger::get("GenerateSingleTriggerFlag")->debug("init");
...
ROOT::RDF::RNode GenerateDoubleTriggerFlag(
    ...
    Logger::get("GenerateDoubleTriggerFlag")->debug("init");
...
ROOT::RDF::RNode MatchDoubleTriggerObject(
    ...
    Logger::get("MatchDoubleTriggerObject")->debug("init");
...
ROOT::RDF::RNode MatchSingleTriggerObject(
    ...
    Logger::get("MatchSingleTriggerObject")->debug("init");
...
ROOT::RDF::RNode GenerateTriggerFlag(
    ...
    Logger::get("GenerateTriggerFlag")->debug("init");
