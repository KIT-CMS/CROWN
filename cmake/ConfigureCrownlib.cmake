...
if(BUILD_CROWNLIB_ONLY)
    ...
    target_link_libraries(CROWNLIB ROOT::ROOTVecOps ROOT::ROOTDataFrame ROOT::RooFit ROOT::GenVector logging correctionlib nlohmann_json::nlohmann_json ${ONNX_RUNTIME_LIB_PATH})
