...
class ProducerOrdering:
    ...
    def __init__(self, config, scope):
        self.global_producers = config["producers"]["global"]
        self.ordering = config["producers"][scope]
    ...
    def get_producer(self, position):
    ...
    def get_global_outputs(self):
        ...
        for producer in self.global_producers:
            if producer.get_outputs("global") != None:
                outputs.extend(
                    [
                        quantity
    ...
    def invalid_inputs(self, inputs, outputs):
        wrong_inputs = []
        for input in inputs:
    ...
    def find_inputs(self, producer, inputs):
        producers_to_relocate = set()
    ...
    def relocate_producer(self, producer, old_position, new_position):
        log.debug(
