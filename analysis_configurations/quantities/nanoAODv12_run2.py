...
"""dtype: Int_t; description: Additional low-pt ak4 CHS jets for Type-1 MET re-correction """
...
"""dtype: UChar_t; description: cut-based ID Fall17V2 (0:fail, 1:veto, 2:loose, 3:medium, 4:tight) """
...
"""dtype: Float_t; description: Relative isolation in matched jet (1/ptRatio-1, pfRelIso04_all if no matched jet in Run2) """
...
"""dtype: Float_t; description: mini PF relative isolation, total (with scaled rho*EA Fall17V2 PU corrections) in Run2 """
Electron_miniPFRelIso_chg = NanoAODQuantity("Electron_miniPFRelIso_chg")
"""dtype: Float_t; description: mini PF relative isolation, charged component in Run2 """

Electron_mvaIso = NanoAODQuantity("Electron_mvaIso")
"""dtype: Float_t; description: MVA Iso ID score, Fall17V2 """
Electron_mvaIso_WP80 = NanoAODQuantity("Electron_mvaIso_WP80")
"""dtype: Bool_t; description: MVA Iso ID WP80, Fall17V2 """
Electron_mvaIso_WP90 = NanoAODQuantity("Electron_mvaIso_WP90")
"""dtype: Bool_t; description: MVA Iso ID WP90, Fall17V2 """
Electron_mvaIso_WPL = NanoAODQuantity("Electron_mvaIso_WPL")
"""dtype: Bool_t; description: MVA Iso ID loose WP, Fall17V2 """

Electron_mvaNoIso = NanoAODQuantity("Electron_mvaNoIso")
"""dtype: Float_t; description: MVA noIso ID score, Fall17V2 """
Electron_mvaNoIso_WP80 = NanoAODQuantity("Electron_mvaNoIso_WP80")
"""dtype: Bool_t; description: MVA noIso ID WP80, Fall17V2 """
Electron_mvaNoIso_WP90 = NanoAODQuantity("Electron_mvaNoIso_WP90")
"""dtype: Bool_t; description: MVA noIso ID WP90, Fall17V2 """
Electron_mvaNoIso_WPL = NanoAODQuantity("Electron_mvaNoIso_WPL")
"""dtype: Bool_t; description: MVA noIso ID loose WP, Fall17V2 """

Electron_pfRelIso03_all = NanoAODQuantity("Electron_pfRelIso03_all")
"""dtype: Float_t; description: PF relative isolation dR=0.3 with 94 EffArea, total (with rho*EA Fall17V2 PU corrections) in Run2 """
Electron_pfRelIso03_chg = NanoAODQuantity("Electron_pfRelIso03_chg")
"""dtype: Float_t; description: PF relative isolation dR=0.3 with 94 EffArea, charged component in Run2 """
...
"""dtype: Int_t; description: slimmedJets, i.e. ak4 PFJets CHS with JECs applied, after basic selection (pt > 15) """
...
"""dtype: UChar_t; description: Pileup ID flags with 106X (2018) training """
...
"""dtype: Bool_t; description: Trigger/flag bit (process: NANO) """
L1_IsoTau40er2p1_ETMHF80 = NanoAODQuantity("L1_IsoTau40er2p1_ETMHF80")
"""dtype: Bool_t; description: Trigger/flag bit (process: NANO) """
...
"""dtype: UChar_t; description: cut-based ID bitmap, Fall17V2, (0:fail, 1:loose, 2:medium, 3:tight) """
...
"""dtype: Float_t; description: H over E (Run2) """
...
"""dtype: Int_t; description: Fall17V2 VID compressed bitmap (MinPtCut,PhoSCEtaMultiRangeCut,PhotonHcalOverEcalBcCut,PhoFull5x5SigmaIEtaIEtaCut,PhoGenericRhoPtScaledCut,PhoGenericRhoPtScaledCut,PhoGenericRhoPtScaledCut), 2 bits per cut """
...
"""dtype: Float_t; description: PF relative isolation dR=0.3, total (with Fall17V2 rho*EA PU corrections) """
Photon_pfRelIso03_chg = NanoAODQuantity("Photon_pfRelIso03_chg")
"""dtype: Float_t; description: PF relative isolation dR=0.3, charged component (with Fall17V2rho*EA PUcorrections) """
...
"""dtype: Int_t; description: slimmedBoostedTaus after basic selection (pt > 40 && tauID('decayModeFindingNewDMs') && (tauID('byVVLooseIsolationMVArun2017v2DBoldDMwLT2017') || tauID('byVVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017') || tauID('byVVLooseIsolationMVArun2017v2DBnewDMwLT2017'))) """
...
"""dtype: UChar_t; description: IsolationMVArun2DBoldDMdR0p3wLT ID working point (2017v2): 1 = VVLoose, 2 = VLoose, 3 = Loose, 4 = Medium, 5 = Tight, 6 = VTight, 7 = VVTight """
...
"""dtype: Float_t; description: byIsolationMVArun2DBoldDMdR0p3wLT raw output discriminator (2017v2) """
