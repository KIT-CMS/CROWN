...
ROOT::RDF::RNode DoubleObjectFlag(
    ...
    const std::string &particle_1,
     const std::string &particle_2,
    ...
    const std::string &triggerobject_filterbit,
     const std::string &hlt_path,
    const float &pt_threshold_1,
     const float &pt_threshold_2,
    const float &eta_threshold_1,
     const float &eta_threshold_2,
