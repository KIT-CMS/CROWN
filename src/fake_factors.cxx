...
ROOT::RDF::RNode fakefactor_nmssm_lt(ROOT::RDF::RNode df, const std::string &outputname,
    ...
    auto calc_fake_factor = [variation, ff_file, ff_corr_file]
        ...
        if (pt_2 >= 0.) {
            ...
            ff = qcd_frac*qcd_ff*qcd_lep_pt_corr*qcd_lep_iso_corr + wjets_frac*wjets_ff*wjets_lep_pt_corr + ttbar_frac*ttbar_ff*ttbar_lep_pt_corr;
        }
    ...
    auto df1 = df.Define(
        outputname, calc_fake_factor,
        {tau_pt, njets, lep_mt, nbtags, lep_pt, lep_iso});
    return df1;
}
