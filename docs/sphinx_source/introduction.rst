...
It is also possible to use an alternative container instead of the default (``/cvmfs/unpacked.cern.ch/registry.hub.docker.com/kingmakerimages/crown:V0.1``), by using the ``-c``/``--container`` argument.
