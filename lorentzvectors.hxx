...
namespace lorentzvectors{
    ...
    auto buildparticle(auto df, const std::vector<std::string> quantities, const std::string outputname, const int& position){
    ...
    namespace mutau{
        ...
        auto build(auto df, const std::string& pairname, const std::vector<std::string>& muon_quantities, const std::vector<std::string>& tau_quantities,
