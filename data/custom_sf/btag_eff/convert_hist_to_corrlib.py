...
for y in corrs.keys():
        for f in ['b', 'c', 'l']:
                corrs[y]['btag_eff_' + f + '_top'] = correctionlib.convert.from_uproot_THx(path = y + '_UL/btageff__top_' + y + '.root:h_eff_' + f, axis_names = ['eta','pt'])
                corrs[y]['btag_eff_' + f + '_top'].description = 'btag eff (' + f +') for top in ' + y
                corrs[y]['btag_eff_' + f + '_top'].data.flow = "clamp"
                corrs[y]['btag_eff_' + f + '_top'].name = 'top_' + f

                corrs[y]['btag_eff_' + f + '_ewk'] = correctionlib.convert.from_uproot_THx(path = y + '_UL/btageff__ewk_' + y + '.root:h_eff_' + f, axis_names = ['eta','pt'])
                corrs[y]['btag_eff_' + f + '_ewk'].description = 'btag eff (' + f +') for ewk in ' + y
