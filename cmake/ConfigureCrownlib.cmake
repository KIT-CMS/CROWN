...
include_directories(
  ${CMAKE_SOURCE_DIR}/analysis_configurations/${ANALYSIS}/cpp_addons/src)
include_directories(
  ${CMAKE_SOURCE_DIR}/analysis_configurations/${ANALYSIS}/cpp_addons/include)
...
find_library(CROWNLIB_FOUND CROWNLIB HINTS ${INSTALLDIR}/lib
