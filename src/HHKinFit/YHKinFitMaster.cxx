...
YHKinFitMaster::YHKinFitMaster(
    ...
    ROOT::Math::PtEtaPhiEVector tauvis1, ROOT::Math::PtEtaPhiEVector tauvis2,
    ROOT::Math::PtEtaPhiEVector met, TMatrixD met_cov, bool Ytautau)
    : m_bjet1(bjet1), m_bjet2(bjet2), m_bjet_reso1(bjet_reso_1),
      ...
      m_covRecoil(2, 2), m_V_inv(2, 2), m_mh(std::vector<int>()), m_mY(std::vector<int>()),
...
void YHKinFitMaster::Fit(int mh, int mY) {
    ...
    if (m_tauvis1.E() < mtau) {
        ROOT::Math::PtEtaPhiMVector tmp_tau1 = (ROOT::Math::PtEtaPhiMVector) m_tauvis1;
        tmp_tau1.SetM(mtau);
        m_tauvis1 = (ROOT::Math::PtEtaPhiEVector) tmp_tau1;
    }
    if (m_tauvis2.E() < mtau) {
        ROOT::Math::PtEtaPhiMVector tmp_tau2 = (ROOT::Math::PtEtaPhiMVector) m_tauvis2;
        tmp_tau2.SetM(mtau);
        m_tauvis2 = (ROOT::Math::PtEtaPhiEVector) tmp_tau2;
    }

    ROOT::Math::PtEtaPhiEVector Htt_vis = m_tauvis1 + m_tauvis2;
    ROOT::Math::PtEtaPhiEVector Hbb = m_bjet1 + m_bjet2;
    ...
    ROOT::Math::PtEtaPhiEVector tmp_bjet_2 = m_bjet2;
    ...
    double max_E_b1 = ConstrainEnergy(Hbb, tmp_bjet_2, m_bjet1, mHbbHypo); // Calculate b1 with b2 fixed
    ...
    double min_E_b1 = ConstrainEnergy(Hbb, tmp_bjet_2, m_bjet1, mHbbHypo); // Calculate b1 with b2 fixed
    ...
    static const int nloopmax = 300;

    ROOT::Math::PtEtaPhiEVector bjet_1_fit = m_bjet1;
    ROOT::Math::PtEtaPhiEVector bjet_2_fit = m_bjet2;
    ROOT::Math::PtEtaPhiEVector tau_1_fit = m_tauvis1;
    ROOT::Math::PtEtaPhiEVector tau_2_fit = m_tauvis2;
    ...
    for (int iloop = 0; iloop < nloopmax; iloop++) { // FIT loop
        ...
        new_E_b2 = ConstrainEnergy(Hbb, bjet_1_fit, m_bjet2, mHbbHypo);
        ...
        new_E_tau2 = ConstrainEnergy(Htt_vis, tau_1_fit, m_tauvis2, mHttHypo);
        ...
        m_chi2_b1 = Chi2_V4(m_bjet1, bjet_1_fit, m_bjet_reso1);
        m_chi2_b2 = Chi2_V4(m_bjet2, bjet_2_fit, m_bjet_reso2);
...
TMatrixD YHKinFitMaster::CalcCov(ROOT::Math::PtEtaPhiEVector p4, double dE) {
...
double YHKinFitMaster::ConstrainEnergy(ROOT::Math::PtEtaPhiEVector p4_mother,
                                       ROOT::Math::PtEtaPhiEVector p4_1,
                                       ROOT::Math::PtEtaPhiEVector p4_2,
                                       int mHypo) {
    // ROOT::Math::PtEtaPhiEVector new_p4_1 = p4_1;
    ROOT::Math::PtEtaPhiEVector new_p4_2 = p4_2;
    ROOT::Math::PtEtaPhiEVector new_p4_mother = p4_mother;
...
double YHKinFitMaster::Chi2_V4(ROOT::Math::PtEtaPhiEVector p4_reco,
    ...
    double dE_fit = CalcBjetResolution(p4_fit, res);
...
double YHKinFitMaster::Chi2_Balance(ROOT::Math::PtEtaPhiEVector p4_X_fit) {
    // reco objects
    ROOT::Math::PtEtaPhiEVector p4_X_reco =
    ...
    double chi2 =
        res_px * (m_V_inv[0][0] * res_px + m_V_inv[0][1] * res_py) +
        res_py * (m_V_inv[1][0] * res_px +
                  m_V_inv[1][1] * res_py); // chi2 = res_transponiert * Vinv * res
