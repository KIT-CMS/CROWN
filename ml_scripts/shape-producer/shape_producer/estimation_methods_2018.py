...
def get_triggerweight_for_channel(channel):
    ...
    MCTau_1 = "((byMediumDeepTau2017v2p1VSjet_1<0.5 && byVVVLooseDeepTau2017v2p1VSjet_1>0.5)*crossTriggerMCEfficiencyWeight_vloose_DeepTau_1 + (byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerMCEfficiencyWeight_medium_DeepTau_1)"  # hotfix
    ...
    if "mt" in channel:
        ...
        crossWeight = "("+crossWeightData+")/(("+crossWeightMC+")*(abs(eta_2)<2.1)+(1*abs(eta_2)>2.1))"
...
def get_singlelepton_triggerweight_for_channel(channel):
    ...
    MCTau_1 = "((byMediumDeepTau2017v2p1VSjet_1<0.5 && byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerMCEfficiencyWeight_medium_DeepTau_1 + (byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerMCEfficiencyWeight_medium_DeepTau_1)"  # hotfix
...
def get_eleHLTZvtxWeight_for_channel(channel):
    ...
    if "et" in channel:
        weight = Weight("(trg_singleelectron_35 || trg_singleelectron_32 || trg_crossele_ele24tau30)*0.991 + (!(trg_singleelectron_35 || trg_singleelectron_32 || trg_crossele_ele24tau30))*1.0", "eleHLTZvtxWeight")
    return weight
...
class DYJetsToLLEstimation(EstimationMethod):
    ...
    def get_weights(self):
        if self.atNLO:
            z_stitching_weight = Weight("((genbosonmass >= 50.0) * 3.3042e-05 + (genbosonmass < 50.0)*numberGeneratedEventsWeight*crossSectionPerEventWeight)","z_stitching_weight") # xsec_NNLO [pb] = 2025.74*3, N_inclusive_NLO = 183925831, xsec_NNLO/N_inclusive_NLO = 3.3042e-05; fraction of negative events in 'generatorWeight'
        else:
            z_stitching_weight = Weight("((genbosonmass >= 50.0)*0.0000606542*((npartons == 0 || npartons >= 5)*1.0 + (npartons == 1)*0.194267667208 + (npartons == 2)*0.21727746547 + (npartons == 3)*0.26760465744 + (npartons == 4)*0.294078683662) + (genbosonmass < 50.0)*numberGeneratedEventsWeight*crossSectionPerEventWeight)", "z_stitching_weight")
    ...
    def get_weights(self):
        if self.channel.name in ["mt"]:
            return Weights(
                ...
                # Weight("isoWeight_1*idWeight_1*((pt_1>=25)*(trigger_24_27_Weight_1)+(pt_1<25)*(abs(eta_2)<2.1)*(crossTriggerDataEfficiencyWeight_medium_DeepTau_2/((pt_1<25)*(abs(eta_2)<2.1)*crossTriggerEMBEfficiencyWeight_medium_DeepTau_2+(abs(eta_2)>=2.1)+(pt_1>=25)))*crossTriggerEmbeddedWeight_1)", "lepton_sf"),
                Weight("isoWeight_1*idWeight_1", "lepton_sf"),
                Weight("((pt_1>=25)*(pt_1<28)*(trigger_24_Weight_1)+(pt_1>=28)*(trigger_24_27_Weight_1)+(pt_1<25)*(abs(eta_2)<2.1)*(crossTriggerDataEfficiencyWeight_medium_DeepTau_2/((pt_1<25)*(abs(eta_2)<2.1)*crossTriggerEMBEfficiencyWeight_medium_DeepTau_2+(abs(eta_2)>=2.1)+(pt_1>=25)))*crossTriggerEmbeddedWeight_1)", "triggerweight"),  # hotfix
                self.get_tauByIsoIdWeight_for_channel(self.channel.name),
            ...
            return Weights(
                ...
                # Weight("idWeight_1*isoWeight_1*(crossTriggerEmbeddedWeight_1*(crossTriggerDataEfficiencyWeight_medium_DeepTau_2/((pt_1<33)*crossTriggerEMBEfficiencyWeight_medium_DeepTau_2+(pt_1>=33)))*(pt_1<33)+(pt_1>=33)*trigger_32_35_Weight_1)", "lepton_sf"),
                self.get_tauByIsoIdWeight_for_channel(self.channel.name),
                # Weight("(pt_2<=20)*1.0+(pt_2>20&&pt_2<=25)*0.93+(pt_2>25&&pt_2<=30)*1.07+(pt_2>30&&pt_2<=35)*1.07+(pt_2>35&&pt_2<=40)*1.08+(pt_2>40)*1.05", "emb_tauID_correction_weight"),
            ...
            return Weights(
                ...
                Weight("(((byMediumDeepTau2017v2p1VSjet_1<0.5 && byVVVLooseDeepTau2017v2p1VSjet_1>0.5)*crossTriggerDataEfficiencyWeight_vloose_DeepTau_1 + (byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerDataEfficiencyWeight_medium_DeepTau_1)*((byMediumDeepTau2017v2p1VSjet_2<0.5 && byVVVLooseDeepTau2017v2p1VSjet_2>0.5)*crossTriggerDataEfficiencyWeight_vloose_DeepTau_2 + (byMediumDeepTau2017v2p1VSjet_2>0.5)*crossTriggerDataEfficiencyWeight_medium_DeepTau_2))/(((byMediumDeepTau2017v2p1VSjet_1<0.5 && byVVVLooseDeepTau2017v2p1VSjet_1>0.5)*crossTriggerEMBEfficiencyWeight_vloose_DeepTau_1 + (byMediumDeepTau2017v2p1VSjet_1>0.5)*crossTriggerEMBEfficiencyWeight_medium_DeepTau_1)*((byMediumDeepTau2017v2p1VSjet_2<0.5 && byVVVLooseDeepTau2017v2p1VSjet_2>0.5)*crossTriggerEMBEfficiencyWeight_vloose_DeepTau_2 + (byMediumDeepTau2017v2p1VSjet_2>0.5)*crossTriggerEMBEfficiencyWeight_medium_DeepTau_2))","triggerweight"),  # hotfix
                self.get_tauByIsoIdWeight_for_channel(self.channel.name),
                # Weight("((decayMode_1==0)*0.88+(decayMode_1==1)*1.10+(decayMode_1==10)*1.04+(decayMode_1==11)*1.00)", "emb_tauID_correction_weight1"),
                # Weight("((decayMode_2==0)*0.88+(decayMode_2==1)*1.10+(decayMode_2==10)*1.04+(decayMode_2==11)*1.00)", "emb_tauID_correction_weight2"),
    ...
    def get_weights(self):
        return Weights(
            ...
            Weight("((0.0008662455*((npartons <= 0 || npartons >= 5)*1.0 + (npartons == 1)*0.174101755934 + (npartons == 2)*0.136212630745 + (npartons == 3)*0.0815667415121 + (npartons == 4)*0.06721295702670023)) * (genbosonmass>=0.0) + numberGeneratedEventsWeight * crossSectionPerEventWeight * (genbosonmass<0.0))",
                 "wj_stitching_weight"), # xsec_NNLO [pb] = 61526.7, N_inclusive = 71026861, xsec_NNLO/N_inclusive = 0.0008662455 [pb] weights: [1.0, 0.1741017559343336, 0.13621263074538312, 0.08156674151214884, 0.06721295702670023]
